...
// const nums=[];
//
// strNums.forEach(function(item){
//     nums.push(parseInt(item,10))
// });
//
//Problem above is that forEach returns undefined, need to use .map instead
const nums = strNums.map(function(item) {
...
const evenNumsArr = nums.filter(num => num % 2 == 0);

const sumEvens = evenNumsArr.reduce(add, 0);
