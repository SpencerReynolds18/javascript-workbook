...
function rockPaperScissors(hand1, hand2) {
    ...
    if (typeof(hand1) != 'string' && typeof(hand2) != 'string') {
        return console.log('Invalid entry, please choose rock, paper, or scissors')
    }
    //making sure the hands entered are strings

    const isRockPaperScissors = (hand) => {
            if (hand != 'rock' && hand != 'paper' && hand != 'scissors') {
                return true;
            }
        };
        //writing a function to check if a hand is valid, then will use it for each hand
    if (isRockPaperScissors(hand1)) {
        return console.log('Invalid entry from player 1, please choose rock, paper, or scissors')
    };
    if (isRockPaperScissors(hand2)) {
        return console.log('Invalid entry from player 2, please choose rock, paper, or scissors')
    };
    ...
    if (hand1 == 'rock' && hand2 == "paper") {
        return console.log("Hand two wins!")
    }

    if (hand1 == 'rock' && hand2 == "scissors") {
        return console.log("Hand one wins!")
    }
